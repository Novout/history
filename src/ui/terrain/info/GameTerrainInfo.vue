<template>
  <Modal>
    <div
      ...
      class="flex w-auto max-h-screen md:max-h-3/4 bg-blur"
    >
      <div
      ...
      >
        ...
        <div v-if="terrain.city" class="flex flex-col w-full gap-2">
          ...
          <p>
            Capacidade Militar: {{ terrain.city.structure.militaryAcademy * 5 }}
          </p>
        </div>
      ...
      >
        ...
        >
          ...
          <div
            :class="[
              terrain.city.structure.townHall <= terrain.city.structure.wall ||
        ...
        >
          ...
          >
            ...
            <Button
              @click="APP.setStructure(APP.player, 'academic_center', terrain)"
