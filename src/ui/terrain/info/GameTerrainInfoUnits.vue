<template>
  <div class="flex flex-col w-full gap-2">
    ...
    <div class="flex flex-col gap-5 w-auto border border-dark-100 shadow-lg p-5 rounded-lg bg-dark-800">
      <H2 class="mb-2">Recrutar Tropas</H2>
      ...
      <div v-if="terrain.units?.squad">
        <div class="flex gap-2 items-center">
          <p>Lanceiro</p>
          <input class="bg-transparent border-transparent w-10 text-white text-xl" v-model="recruit.spearman" type="number" />
        </div>
        <div class="flex gap-2 items-center">
          <p>Arqueiro</p>
          <input class="bg-transparent border-transparent w-10 text-white text-xl" v-model="recruit.archer" type="number" />
        </div>
        <div class="flex gap-2 items-center">
          <p>Catapulta</p>
          <input class="bg-transparent border-transparent w-10 text-white text-xl" v-model="recruit.catapult" type="number" />
        </div>
        <div class="flex gap-2 items-center">
          <p>Dragão</p>
          <input class="bg-transparent border-transparent w-10 text-white text-xl" v-model="recruit.dragon" type="number" />
        </div>
      </div>
